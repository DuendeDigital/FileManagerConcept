...
class newFilesform extends StatefulWidget {
  String _file_path = "";

  newFilesform(String path) {
    _file_path = path;
  }

  @override
  State<newFilesform> createState() => newFilesformState(_file_path);
}

class newFilesformState extends State<newFilesform> {
  //GLOBALS
