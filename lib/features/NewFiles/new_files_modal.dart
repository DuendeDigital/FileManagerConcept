...
import 'package:keepit/features/traverse/widgets/bottomsheet_data.dart'
    as bottomsheets;
import 'newFilesdatePicker.dart';

List<String> files_shared = [];
List<String> currentfile = [];

class new_files extends StatefulWidget {

  static const routeName = '/new_files_modal';

  void setup() async{
    print("initiated constructor");

    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String> files = await prefs.getStringList("new_files_added") ?? ["Empty"];
  ...
  @override
  State<new_files> createState() => _new_filesState();
}

class _new_filesState extends State<new_files>
  ...
  var showing = 0;
  int fileIndex = 0;
  String file_path = files_shared[0];
  ...
  Widget file_type(String path) {
    ...
    if (fileExt.toString() == "jpg" ||
      ...
      type = Image.file(File(files_shared[showing]),
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    files_shared[showing == 0 ? 0 : showing].substring(
                ...
                files_shared.length == 1
                    ? ClipRRect(
                        ...
                        child: SizedBox.fromSize(
                          ...
                          child: file_type(files_shared[0]),
                        ),
                      )
                    : CarouselSlider(
                          ...
                          onPageChanged: (index, reason) {
                            ...
                            setState(() {
                              ...
                              if (showing == files_shared.length) {
                                showing = 0;
                                file_type(files_shared[showing]);
                                print("Current Index First ${showing}");
                              } else {
                                file_type(files_shared[1]);
                            ...
                            onTap: (() async{
                              ...
                              current_cache_file.add(file_path
                                  ...
                                  .replaceAll(
                                      "/storage/emulated/0/keepit/Shared/",
                                      "/data/user/0/app.keepit/cache/"));
                              String newFilename = move_file(files_shared[showing == 0 ? 0 : showing]);
