...
class _DocsState extends State<Docs> {
  ...
  static List<String> documents_files = [];
  static int _tab_length = 1;
  static List<String> _tab_paths = [];
  static List<FileSystemEntity> all_documents = [];
        ...
        child: Consumer(
          ...
          builder:
            ...
            return DefaultTabController(
              length: provider.documentTabs.length,
              ...
              child: Scaffold(
                appBar: AppBar(
                  ...
                  bottom: PreferredSize(
                    ...
                    child: TabBar(
                        ...
                        isScrollable:
                            provider.documentTabs.length < 3 ? false : true,
                        tabs: Constants.map<Widget>(
                          provider.documentTabs,
                          (index, label) {
                        ...
                        onTap: (val) {
                          ...
                          setState(() {
                            ...
                            current_tab = val;
                            provider.switchCurrentFiles(provider.document,
                                provider.documentTabs[val], 'documents');
                            print("document are : ${provider.document}");
                            selectItems.clear();
                            isMultiSelectionEnabled = false;
                          });
                        }),
                      ...
                      onSelected: (value) async {
                        ...
                        switch (value) {
                          case _MenuValues.SelectAll:
                            // List list = provider.currentDocumentFiles;
                            ...
                            if (filters.length == 0) {
                              ...
                              if (current_tab == 0) {
                                ...
                                list = provider.currentDocumentFiles;
                              }
                ...
                body: Container(
                    ...
                    child: filters.isEmpty
                        ? Visibility(
                            visible: provider.onePackDocuments.isNotEmpty,
                            replacement: Center(
                            ...
                            child: TabBarView(
                                ...
                                children: [
                                  for (var tab in provider.documentTabs)
                                    buildTabView(tab),
                                ]),
                          )
                        : Container(
    ...
    return Consumer(builder:
      ...
      timer = Timer.periodic(Duration(seconds: 1), (Timer t) {
        if (changeTabIns == true) {
          if (provider.documentTabs.length < 2) {
            print("Tabs is not loaded fully: ${provider.documentTabs.length}");
          } else {
            setState(() {
              changeTabIns = false;
      ...
      if (name == "All") {
        List list = provider.document;
        List list_obj = provider.onePackDocuments;
        List<FileOBJ> search = provider.onePackDocuments;
        list_Search = search;

        Future.delayed(Duration(milliseconds: 1000), () {
          if (switch_value == true) {
            //print("switch val is: ${switch_value}");
            provider.switchCurrentFiles(provider.document, name, 'documents');
            List list_obj = provider.onePackDocuments;
            switch_value = false;
            isMultiSelectionEnabled = false;
          }
        ...
        //print("keep files onepack: ${list_obj}");
      ...
      ? GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            var file_date =
                DateFormat('dd/MM/yyyy').format(sortedItems[index].file_date);
            String keep_status = sortedItems[index].keep_status.toString();
            print("keep status is: ${keep_status}");
